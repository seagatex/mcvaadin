...
public abstract class McApplication extends Application {
    ...
    public void init() {
        ...
        // Initialize a new ui builder to main window
        uiBuilder = new UIBuilder(w);
...
public void bindKey(Container container0, int int1, int[] int2, McListener mclistener3) {  uiBuilder.bindKey(container0, int1, int2, mclistener3); }
public Button bindKey(Button button0, int int1, int[] int2) { return uiBuilder.bindKey(button0, int1, int2); }
